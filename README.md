...
&nbsp;
## 회고
이번 프로젝트는 혼자 진행하는 만큼, 사용자의 시선을 즉각적으로 사로잡을 수 있는 시각적 완성도에 초점을 맞췄습니다. 단순히 공공 API를 가져오는 것에 그치지 않고, 서비스에 최적화된 형태로 "데이터를 직접 정제 및 구조화(JSON)"하여 활용했습니다.

기획부터 디자인, 개발 전반을 아우르며 서비스의 공익성과 시장성 사이의 균형을 치열하게 고민했습니다. 특히 마지막 발표를 준비하며, 공들여 만든 결과물의 가치를 설득력 있게 전달하는 PR(Public Relations)의 중요성을 깊이 체감할 수 있었던 소중한 경험이었습니다.
