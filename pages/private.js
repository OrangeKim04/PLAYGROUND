...
export default function Private() { // Include navigation prop
    ...
    return (
        <ScrollView style={styles.container}>
           <Text>
            ...
            제1조 (개인정보의 처리목적){'\n'}
            놀이터 백과(이하 ‘회사’라 한다)는 개인정보 보호법 제30조에 따라 정보 주체의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보 처리방침을 수립, 공개합니다. 회사는 다음의 목적을 위하여 개인정보를 처리합니다. 처리하고 있는 개인정보는 다음의 목적 이외의 용도로는 이용되지 않으며, 이용 목적이 변경되는 경우에는 개인정보보호법 제18조에 따라 별도의 동의를 받는 등 필요한 조치를 이행할 예정입니다.{'\n\n'}
            ...
            서비스 회원 가입 및 관리 : 회원 탈퇴 시까지 보유{'\n'}
            단, 다음의 사유에 해당하는 경우에는 해당 사유 종료 시까지 보유{'\n'}
            관계 법령 위반에 따른 수사 및 조사 등이 진행 중인 경우에는 해당 수사 및 조사 종료 시까지{'\n'}
            서비스 이용에 따른 채권 및 채무 관계 잔존 시에는 해당 채권, 채무 관계 정산 시까지{'\n\n'}
            ...
            인터넷 서비스 이용과정에서 자동으로 생성되어 수집될 수 있는 항목{'\n'}
